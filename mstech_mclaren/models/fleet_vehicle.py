...
class FleetMclaren(models.Model):
    ...
    equipment = fields.Many2many(comodel_name='equipment.vehicles',relation='fleet_vehicle_equipment',colum1='fleet_id', colum2='equipment_type',string ="Equipamentos")
    #,relation='fleet_vehicle_equipment'    comodel_name='equipment.vehicles'
